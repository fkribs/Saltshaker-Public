 ...
 *
 * Emits onto pluginEvents as a SINGLE channel:
 * - "dolphin:event" with payload: { name: string, payload: any }
 *
 * Example:
 *   pluginEvents.emit("dolphin:event", { name: "GameStart", payload: settingsObj })
 */
module.exports = function registerDolphinBridge({ ipcMain, pluginEvents }) {
  ...
  const requestedEventsByPlugin = new Map();
